...
- `GET /api/organizations/{id}/missing-invoices`: medidores sin factura del mes.

## Seguimiento mensual

Cada medidor recibe automáticamente un código permanente como `EPEN-000001`.
Las cargas de meses siguientes se vinculan por número de medidor al mismo código.
Al finalizar cada importación, el sistema compara la carga contra todos los
medidores activos y genera alertas para los suministros faltantes.
